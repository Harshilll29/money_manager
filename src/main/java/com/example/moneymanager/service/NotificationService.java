    ...
    public void sendDailyIncomeExpenseReminder(){
        ...
        for(ProfileEntity profile : profiles){
            ...
            String body = "Hi " + profile.getFullName() + ",<br><br>"
                    ...
                    + "<br><br>Best regards,<br>Money Manager Team,<br>Created By, Harshil Joshi";
            emailService.sendEmail(profile.getEmail(), subject, body);
        }
        log.info("Job completed: sendDailyIncomeExpenseReminder() - Sent to {} profiles", profiles.size());
    }
    ...
    public void sendDailyExpenseSummary(){
        ...
        for (ProfileEntity profile : profiles){
            ...
            if(!todaysExpenses.isEmpty()){
                ...
                table.append("</table>");
                String body = "Hi " +profile.getFullName()+",<br/><br/> Here is a summary of your expenses for today:<br/><br/>"+table+"<br/><br/>Best Regards, <br/>Money Manager Team, <br/>Created By, Harshil Joshi";
